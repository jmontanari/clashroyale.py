...
from clashroyale.api_response import ApiResponse, T as ApiResponseT
import clashroyale.models
from clashroyale import rest
from clashroyale.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(clashroyale.models, klass)

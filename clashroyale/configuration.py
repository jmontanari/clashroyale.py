...
conf = clashroyale.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://api.clashroyale.com/v1" if host is None else host
        """Default Base url
        """
        ...
        self.key_names: str = "Created with clashroyal.py Client"
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("clashroyale")
    ...
    def get_host_settings(self) -> List[HostSetting]:
        ...
        return [
            ...
            {
                'url': "http://api.clashroyale.com/v1",
                'description': "No description provided",
            }
        ]

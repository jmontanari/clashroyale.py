...
class PlayerPathOfLegendRanking(BaseModel):
    """
    ...
    elo_rating: Optional[StrictInt] = Field(default=None, alias="eloRating")
    __properties: ClassVar[List[str]] = ["clan", "tag", "name", "expLevel", "rank", "eloRating"]

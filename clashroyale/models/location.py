...
class Location(BaseModel):
    ...
    is_country: Optional[StrictBool] = Field(default=None, alias="isCountry")
    country_code: Optional[StrictStr] = Field(default=None, alias="countryCode")
    __properties: ClassVar[List[str]] = ["localizedName", "id", "name", "isCountry", "countryCode"]

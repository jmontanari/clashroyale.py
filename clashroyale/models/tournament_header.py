...
class TournamentHeader(BaseModel):
    """
    TournamentHeader
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["status", "preparationDuration", "createdTime", "firstPlaceCardPrize", "gameMode", "duration", "type", "tag", "creatorTag", "name", "description", "capacity", "maxCapacity", "levelCap"]

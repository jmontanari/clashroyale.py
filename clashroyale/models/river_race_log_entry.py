...
class RiverRaceLogEntry(BaseModel):
    ...
    RiverRaceLogEntry
    """ # noqa: E501
    standings: Optional[List[RiverRaceStanding]] = None
    ...
    __properties: ClassVar[List[str]] = ["standings", "seasonId", "createdDate", "sectionIndex"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "standings": [RiverRaceStanding.from_dict(_item) for _item in obj["standings"]] if obj.get("standings") is not None else None,

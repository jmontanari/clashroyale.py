...
class RiverRaceClan(BaseModel):
    ...
    participants: Optional[List[RiverRaceParticipant]] = None
    period_points: Optional[StrictInt] = Field(default=None, alias="periodPoints")
    __properties: ClassVar[List[str]] = ["tag", "clanScore", "badgeId", "name", "fame", "repairPoints", "finishTime", "participants", "periodPoints"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "participants": [RiverRaceParticipant.from_dict(_item) for _item in obj["participants"]] if obj.get("participants") is not None else None,
            "periodPoints": obj.get("periodPoints")
        })
        return _obj

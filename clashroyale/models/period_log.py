...
class PeriodLog(BaseModel):
    ...
    PeriodLog
    """ # noqa: E501
    items: Optional[List[PeriodLogEntry]] = None
    period_index: Optional[StrictInt] = Field(default=None, alias="periodIndex")
    __properties: ClassVar[List[str]] = ["items", "periodIndex"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [PeriodLogEntry.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,

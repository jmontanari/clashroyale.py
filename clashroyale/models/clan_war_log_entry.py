...
class ClanWarLogEntry(BaseModel):
    ...
    ClanWarLogEntry
    """ # noqa: E501
    standings: Optional[List[ClanWarStanding]] = None
    ...
    __properties: ClassVar[List[str]] = ["standings", "seasonId", "participants", "createdDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "standings": [ClanWarStanding.from_dict(_item) for _item in obj["standings"]] if obj.get("standings") is not None else None,

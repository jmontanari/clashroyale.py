...
class Items(BaseModel):
    ...
    support_items: Optional[List[Item]] = Field(default=None, alias="supportItems")
    __properties: ClassVar[List[str]] = ["items", "supportItems"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.items:
            ...
            _dict['items'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in support_items (list)
        _items = []
        if self.support_items:
            for _item_support_items in self.support_items:
                if _item_support_items:
                    _items.append(_item_support_items.to_dict())
            _dict['supportItems'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "supportItems": [Item.from_dict(_item) for _item in obj["supportItems"]] if obj.get("supportItems") is not None else None
        })
        return _obj

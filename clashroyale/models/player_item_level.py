...
class PlayerItemLevel(BaseModel):
    ...
    star_level: Optional[StrictInt] = Field(default=None, alias="starLevel")
    evolution_level: Optional[StrictInt] = Field(default=None, alias="evolutionLevel")
    used: Optional[StrictBool] = None
    name: Optional[StrictStr] = None
    max_level: Optional[StrictInt] = Field(default=None, alias="maxLevel")
    elixir_cost: Optional[StrictInt] = Field(default=None, alias="elixirCost")
    max_evolution_level: Optional[StrictInt] = Field(default=None, alias="maxEvolutionLevel")
    icon_urls: Optional[Dict[str, Any]] = Field(default=None, alias="iconUrls")
    __properties: ClassVar[List[str]] = ["id", "rarity", "count", "level", "starLevel", "evolutionLevel", "used", "name", "maxLevel", "elixirCost", "maxEvolutionLevel", "iconUrls"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "count": obj.get("count"),
            "level": obj.get("level"),
            "starLevel": obj.get("starLevel"),
            "evolutionLevel": obj.get("evolutionLevel"),
            "used": obj.get("used"),
            "name": obj.get("name"),
            "maxLevel": obj.get("maxLevel"),
            "elixirCost": obj.get("elixirCost"),
            "maxEvolutionLevel": obj.get("maxEvolutionLevel"),
            "iconUrls": obj.get("iconUrls")
        })
        return _obj

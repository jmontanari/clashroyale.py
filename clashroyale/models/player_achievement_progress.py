...
class PlayerAchievementProgress(BaseModel):
    ...
    completion_info: Optional[StrictStr] = Field(default=None, alias="completionInfo")
    __properties: ClassVar[List[str]] = ["stars", "value", "name", "target", "info", "completionInfo"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "info": obj.get("info"),
            "completionInfo": obj.get("completionInfo")
        })
        return _obj
